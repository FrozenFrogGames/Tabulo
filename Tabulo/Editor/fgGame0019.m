...
- (void)buildScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
    ...
    f3ViewAdaptee *pawn = [scene buildPawn:_director node:node6 type:TABULO_PawnFour writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node6 view:pawn writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankOne = [scene buildSmallPlank:_director node:node1 angle:90.f hole:TABULO_OneHole_Four writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node1 view:plankOne writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankTwo = [scene buildSmallPlank:_director node:node5 angle:135.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
