...
- (void)buildScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
    ...
    [scene buildDragControl:_director state:_state node:node12 view:pawnTwo writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragControl:_director state:_state node:node7 view:plankOne writer:dataWriter symbols:dataSymbols];
