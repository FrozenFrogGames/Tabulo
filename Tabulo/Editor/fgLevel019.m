...
- (void)buildScene:(fgTabuloDirector *)_director state:(f3GameState *)_state strategy:(fgLevelStrategy *)_strategy {
    ...
    [scene buildDragPawnControl:_director state:_strategy node:node6 view:pawn writer:dataWriter symbols:dataSymbols];
