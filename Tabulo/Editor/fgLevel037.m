...
@implementation fgLevel037

- (void)buildScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
/*
    [scene addPointFrom:0 Radius:3.5f Angle:140.f];
    [scene addPointFrom:0 Radius:3.5f Angle:220.f]; // 2
    [scene addPointFrom:1 Radius:3.5f Angle:140.f];
    [scene addPointFrom:2 Radius:3.5f Angle:220.f]; // 4
    [scene addPointFrom:3 Radius:1.75f Angle:205.f];
    [scene addPointFrom:3 Radius:1.75f Angle:295.f]; // 6
    [scene addPointFrom:4 Radius:1.75f Angle:65.f];
    [scene addPointFrom:4 Radius:1.75f Angle:155.f]; // 8
    [scene addPointFrom:5 Radius:1.75f Angle:205.f];
    [scene addPointFrom:6 Radius:1.75f Angle:295.f]; // 10
    [scene addPointFrom:8 Radius:1.75f Angle:155.f];
    [scene addPointFrom:9 Radius:1.75f Angle:270.f]; // 12
    [scene addPointFrom:9 Radius:2.5f Angle:340.f];
    [scene addPointFrom:11 Radius:2.5f Angle:20.f]; // 14
    [scene computePoints];
    ...
    [scene buildHouse:_director node:node9 type:TABULO_PawnTwo state:_state writer:dataWriter symbols:dataSymbols];
    [scene buildPillar:_director node:node10 writer:dataWriter symbols:dataSymbols];
    [scene buildHouse:_director node:node11 type:TABULO_PawnThree state:_state writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPawnControl:_director state:_state node:node3 view:pawnOne writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *pawnTwo = [scene buildPawn:_director state:_state node:node4 type:TABULO_PawnThree writer:dataWriter symbols:dataSymbols];
    [scene buildDragPawnControl:_director state:_state node:node4 view:pawnTwo writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankOne = [scene buildMediumPlank:_director state:_state node:node2 angle:50.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director state:_state node:node2 view:plankOne writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankTwo = [scene buildMediumPlank:_director state:_state node:node14 angle:20.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director state:_state node:node14 view:plankTwo writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankThree = [scene buildSmallPlank:_director state:_state node:node5 angle:205.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director state:_state node:node5 view:plankThree writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildEdgesForPawn:_director type:TABULO_HaveMediumPlank node:node13 origin:node9 target:node10 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPawn:_director type:TABULO_HaveMediumPlank node:node13 origin:node10 target:node9 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPawn:_director type:TABULO_HaveMediumPlank node:node14 origin:node10 target:node11 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPawn:_director type:TABULO_HaveMediumPlank node:node14 origin:node11 target:node10 writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildEdgesForPlank:_director type:TABULO_HaveMediumPlank node:node10 origin:node13 target:node14 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveMediumPlank node:node10 origin:node14 target:node13 writer:dataWriter symbols:dataSymbols];
