...
- (void)buildScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
    ...
    f3ViewAdaptee *pawn = [scene buildPawn:_director node:node0 type:TABULO_PawnFour writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node0 view:pawn writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plank = [scene buildMediumPlank:_director node:node1 angle:270.f hole:0 writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node1 view:plank writer:dataWriter symbols:dataSymbols];
