...
- (void)buildSceneForLevel:(fgTabuloDirector *)_director withStrategy:(fgTabuloStrategy *)_strategy {
    ...
    fgHouseNode *node3 = [(fgTabuloStrategy *)_strategy buildHouseNode:[scene getPointAt:3] extend:CGSizeMake(0.8f, 0.8f) writer:dataWriter symbols:dataSymbols];
    ...
    fgHouseNode *node10 = [(fgTabuloStrategy *)_strategy buildHouseNode:[scene getPointAt:10] extend:CGSizeMake(0.8f, 0.8f) writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPawnControl:_director strategy:_strategy node:node3 view:pawnTwo writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPawnControl:_director strategy:_strategy node:node10 view:pawnThree writer:dataWriter symbols:dataSymbols];
