...
@implementation fgLevel015

- (void)loadScene:(fgTabuloDirector *)_director strategy:(fgLevelStrategy *)_strategy {
    
    [scene addPointFrom:0 Radius:2.5f Angle:180.f];
    [scene addPointFrom:0 Radius:2.5f Angle:240.f]; // 2
    [scene addPointFrom:1 Radius:2.5f Angle:180.f];
    [scene addPointFrom:2 Radius:2.5f Angle:240.f]; // 4
    [scene addPointFrom:3 Radius:2.5f Angle:300.f];
    [scene addPointFrom:4 Radius:1.75f Angle:225.f]; // 6
    [scene addPointFrom:4 Radius:2.5f Angle:270.f];
    [scene addPointFrom:4 Radius:1.75f Angle:315.f]; // 8
    [scene addPointFrom:6 Radius:1.75f Angle:225.f];
    [scene addPointFrom:7 Radius:2.5f Angle:270.f]; // 10
    [scene addPointFrom:8 Radius:1.75f Angle:315.f];
    [scene addPointFrom:9 Radius:1.75f Angle:315.f]; // 12
    [scene addPointFrom:10 Radius:1.75f Angle:45.f];
    [scene computePoints];
    ...
    f3ViewAdaptee *pawnTwo = [scene buildPawn:_director state:_strategy node:node3 type:TABULO_PawnOne writer:dataWriter symbols:dataSymbols];
    [scene buildDragPawnControl:_director state:_strategy node:node3 view:pawnTwo writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *pawnThree = [scene buildPawn:_director state:_strategy node:node10 type:TABULO_PawnTwo writer:dataWriter symbols:dataSymbols];
    [scene buildDragPawnControl:_director state:_strategy node:node10 view:pawnThree writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankOne = [scene buildMediumPlank:_director state:_strategy node:node1 angle:0.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director state:_strategy node:node1 view:plankOne writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankTwo = [scene buildSmallPlank:_director state:_strategy node:node6 angle:45.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director state:_strategy node:node6 view:plankTwo writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankThree = [scene buildSmallPlank:_director state:_strategy node:node8 angle:135.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director state:_strategy node:node8 view:plankThree writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildEdgesForPawn:_director type:TABULO_HaveSmallPlank node:node6 origin:node4 target:node9 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPawn:_director type:TABULO_HaveSmallPlank node:node6 origin:node9 target:node4 writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node4 origin:node6 target:node8 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node4 origin:node8 target:node6 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node9 origin:node6 target:node12 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node9 origin:node12 target:node6 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node10 origin:node12 target:node13 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node10 origin:node13 target:node12 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node11 origin:node8 target:node13 writer:dataWriter symbols:dataSymbols];
    [scene buildEdgesForPlank:_director type:TABULO_HaveSmallPlank node:node11 origin:node13 target:node8 writer:dataWriter symbols:dataSymbols];
