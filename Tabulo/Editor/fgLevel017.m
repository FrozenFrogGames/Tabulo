...
- (void)loadScene:(fgTabuloDirector *)_director strategy:(fgLevelStrategy *)_strategy {
    ...
    [scene buildDragPawnControl:_director state:_strategy node:node13 view:pawnThree writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director state:_strategy node:node12 view:plankOne writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director state:_strategy node:node4 view:plankThree writer:dataWriter symbols:dataSymbols];
