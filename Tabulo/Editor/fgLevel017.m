...
- (void)loadScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
    ...
    [scene buildDragPawnControl:_director state:_state node:node13 view:pawnThree writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director state:_state node:node12 view:plankOne writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director state:_state node:node4 view:plankThree writer:dataWriter symbols:dataSymbols];
