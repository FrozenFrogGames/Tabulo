...
- (void)buildSceneForLevel:(fgTabuloDirector *)_director withStrategy:(fgTabuloStrategy *)_strategy {
    ...
    fgHouseNode *node11 = [(fgTabuloStrategy *)_strategy buildHouseNode:[scene getPointAt:11] extend:CGSizeMake(0.8f, 0.8f) writer:dataWriter symbols:dataSymbols];
    ...
    f3GraphNode *node15 = [_strategy buildNode:[scene getPointAt:15] withRadius:1.5f writer:dataWriter symbols:dataSymbols];
    f3GraphNode *node16 = [_strategy buildNode:[scene getPointAt:16] withExtend:CGSizeMake(0.8f, 0.8f) writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildHouse:_director node:node11 type:TABULO_PawnTwo state:_strategy writer:dataWriter symbols:dataSymbols];
    ...
    f3ViewAdaptee *pawnTwo = [scene buildPawn:_director state:_strategy node:node11 type:TABULO_PawnFour writer:dataWriter symbols:dataSymbols];
    [scene buildDragPawnControl:_director strategy:_strategy node:node11 view:pawnTwo writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankOne = [scene buildMediumPlank:_director state:_strategy node:node8 angle:90.f hole:TABULO_OneHole_Two writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director strategy:_strategy node:node8 view:plankOne writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankTwo = [scene buildSmallPlank:_director state:_strategy node:node14 angle:45.f hole:TABULO_OneHole_Four writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director strategy:_strategy node:node14 view:plankTwo writer:dataWriter symbols:dataSymbols];
