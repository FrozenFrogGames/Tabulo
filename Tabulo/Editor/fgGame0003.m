...
- (void)buildScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
    ...
    f3ViewAdaptee *plankOne = [scene buildMediumPlank:_director node:node1 angle:90.f hole:0 writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node1 view:plankOne writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankTwo = [scene buildSmallPlank:_director node:node3 angle:45.f hole:0 writer:dataWriter symbols:dataSymbols];
