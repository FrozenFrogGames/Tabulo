...
- (void)buildSceneForLevel:(fgTabuloDirector *)_director withStrategy:(fgTabuloStrategy *)_strategy {
    ...
    fgHouseNode *node12 = [(fgTabuloStrategy *)_strategy buildHouseNode:[scene getPointAt:12] extend:CGSizeMake(0.8f, 0.8f) writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPawnControl:_director strategy:_strategy node:node12 view:pawnTwo writer:dataWriter symbols:dataSymbols];
