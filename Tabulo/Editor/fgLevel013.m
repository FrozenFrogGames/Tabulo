...
- (void)buildScene:(fgTabuloDirector *)_director state:(fgLevelState *)_state {
    ...
    [scene buildHouse:_director node:node12 type:TABULO_PawnFour state:_state writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragControl:_director state:_state node:node4 view:pawnTwo writer:dataWriter symbols:dataSymbols];
    ...
    f3ViewAdaptee *plankOne = [scene buildSmallPlank:_director state:_state node:node5 angle:90.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node5 view:plankOne writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankTwo = [scene buildSmallPlank:_director state:_state node:node7 angle:135.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node7 view:plankTwo writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankThree = [scene buildMediumPlank:_director state:_state node:node6 angle:90.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragControl:_director state:_state node:node6 view:plankThree writer:dataWriter symbols:dataSymbols];
