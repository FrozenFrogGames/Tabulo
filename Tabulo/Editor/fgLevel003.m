...
- (void)buildSceneForLevel:(fgTabuloDirector *)_director withStrategy:(fgTabuloStrategy *)_strategy {
    ...
    f3ViewAdaptee *plankTwo = [scene buildSmallPlank:_director state:_strategy node:node3 angle:45.f hole:TABULO_HOLE_MAX writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director strategy:_strategy node:node3 view:plankTwo writer:dataWriter symbols:dataSymbols];
