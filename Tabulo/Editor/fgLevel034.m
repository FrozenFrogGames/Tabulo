...
- (void)buildSceneForLevel:(fgTabuloDirector *)_director withStrategy:(fgTabuloStrategy *)_strategy {
    ...
    fgHouseNode *node5 = [(fgTabuloStrategy *)_strategy buildHouseNode:[scene getPointAt:5] extend:CGSizeMake(0.8f, 0.8f) writer:dataWriter symbols:dataSymbols];
    ...
    f3ViewAdaptee *pawnTwo = [scene buildPawn:_director state:_strategy node:node5 type:TABULO_PawnFour writer:dataWriter symbols:dataSymbols];
    ...
    f3ViewAdaptee *plankOne = [scene buildMediumPlank:_director state:_strategy node:node11 angle:135.f hole:TABULO_OneHole_Two writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director strategy:_strategy node:node11 view:plankOne writer:dataWriter symbols:dataSymbols];

    f3ViewAdaptee *plankTwo = [scene buildMediumPlank:_director state:_strategy node:node7 angle:225.f hole:TABULO_OneHole_Two writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director strategy:_strategy node:node7 view:plankTwo writer:dataWriter symbols:dataSymbols];
    
    f3ViewAdaptee *plankThree = [scene buildSmallPlank:_director state:_strategy node:node9 angle:180.f hole:TABULO_OneHole_One writer:dataWriter symbols:dataSymbols];
    ...
    f3ViewAdaptee *plankFour = [scene buildSmallPlank:_director state:_strategy node:node2 angle:180.f hole:TABULO_OneHole_One writer:dataWriter symbols:dataSymbols];
    [scene buildDragPlankControl:_director strategy:_strategy node:node2 view:plankFour writer:dataWriter symbols:dataSymbols];
