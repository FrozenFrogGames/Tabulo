...
- (void)buildSceneForLevel:(fgTabuloDirector *)_director withStrategy:(fgLevelStrategy *)_strategy {
    ...
    [scene buildDragPawnControl:_director strategy:_strategy node:node14 view:pawnOne writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director strategy:_strategy node:node17 view:plankOne writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director strategy:_strategy node:node11 view:plankThree writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director strategy:_strategy node:node5 view:plankFour writer:dataWriter symbols:dataSymbols];
