...
- (void)loadScene:(fgTabuloDirector *)_director strategy:(fgLevelStrategy *)_strategy {
    ...
    [scene buildDragPlankControl:_director state:_strategy node:node11 view:plankOne writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director state:_strategy node:node9 view:plankThree writer:dataWriter symbols:dataSymbols];
    ...
    [scene buildDragPlankControl:_director state:_strategy node:node2 view:plankFour writer:dataWriter symbols:dataSymbols];
