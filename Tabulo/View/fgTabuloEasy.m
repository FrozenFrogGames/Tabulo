...
/*
 ...
 f3GraphNode *node0 = [self buildNode:_producer atPosition:[self getPointAt:0] withExtend:CGSizeMake(0.9f, 0.9f)];
 f3GraphNode *node1 = [self buildNode:_producer atPosition:[self getPointAt:1] withRadius:0.85f];
 f3GraphNode *node2 = [self buildNode:_producer atPosition:[self getPointAt:2] withExtend:CGSizeMake(0.9f, 0.9f)];
 f3GraphNode *node3 = [self buildNode:_producer atPosition:[self getPointAt:3] withRadius:0.85f];
 f3GraphNode *node4 = [self buildNode:_producer atPosition:[self getPointAt:4] withExtend:CGSizeMake(0.9f, 0.9f)];
